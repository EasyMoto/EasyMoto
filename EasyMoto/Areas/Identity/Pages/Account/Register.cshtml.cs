...
namespace EasyMoto.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        /// <summary>
        ///     classe interna com os dados que serão recolhidos (definimos os dados que vão ser recolhidos)
        /// </summary>
        public class InputModel
        {
            ...
            /// <summary>
            /// dados dos utilizadores, a serem associados ao registo, estou a associar ao input
            /// </summary>

            public  Utilizadores utilizadores { get; set; }

        } //fim da inner classe (classe dentro de classe)
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
           ...
           // ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                //cria obj chamado createuser
                var user = CreateUser();

                //atribui o email ao createuser
                await _userStore.SetUserNameAsync(user, Input.Email, CancellationToken.None);
                await _emailStore.SetEmailAsync(user, Input.Email, CancellationToken.None);

                // operação de criar um novo utilizador, estou a injetar a pw no createuser
                ...
                if (result.Succeeded)
                {
                    ...
                    //preparar mensagem a ser enviada para o email do novo utilizador
