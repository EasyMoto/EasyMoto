...
namespace EasyMoto.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Marca")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Marca")] Categorias categorias)
        {
            if (id != categorias.Id)
            {
                return NotFound();
